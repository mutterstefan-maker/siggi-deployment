...
class AnalyticsEngine:
    ...
    def get_analytics_summary_for_prompt(self, days=7):
        """Gibt Analytics-Text für SIGGI-Prompts zurück"""
        ...
        if users == 0:
            return f"Website-Statistiken ({days} Tage): Noch keine Daten verfügbar"
        
        return f"Website-Statistiken (letzte {days} Tage): {users} Besucher, {pageviews} Seitenaufrufe, {bounce_rate}% Absprungrate, Ø {summary['avg_session_duration']}s pro Sitzung"
